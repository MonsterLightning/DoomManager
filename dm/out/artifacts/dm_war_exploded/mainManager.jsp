...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('images/bg.jpg')">
		...
		<div style="padding-top: 70px;padding-right: 20px;">当前用户：&nbsp;<font color="red" >${currentUser[0].managerName }</font></div>
	</div>
</div>
		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<div class="span10">
						<jsp:include page="${mainPage==null?'dormManager/blank.jsp':mainPage}"></jsp:include>
					</div>
			</div>
		</div>
</body>
