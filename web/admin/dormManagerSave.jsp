...
<div class="data_list">
		...
		<form action="/dormManSaveCheck?site=dormManager" method="post" onsubmit="return checkForm()">
			<div class="data_form" >
				<input type="hidden" id="dormManId" name="dormManId" value="${dormManager.dormManId }"/>
					...
					<div align="center">
						...
						&nbsp;<button class="btn btn-primary" type="button" onclick="javascript:location.href='/dormManager?site=dormManager'">返回</button>
						<%
							session.removeAttribute("dormManId");
