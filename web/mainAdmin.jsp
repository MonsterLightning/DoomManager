...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('images/bg.jpg')">
		...
		<div style="padding-top: 70px;padding-right: 20px;">当前用户：&nbsp;<span style="color: red">${currentUser[0].userName }</span></div>
	</div>
</div>
		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li><a href="/dormManager?site=dormManager"><i class="icon-chevron-right"></i>宿舍管理员管理</a></li>
					...
					<li><a href="login?action=logout"><i class="icon-chevron-right"></i>退出系统</a></li>
				</ul>
			</div>
					<div class="span10">
